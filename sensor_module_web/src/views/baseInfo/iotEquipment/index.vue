        ...
        <lay-card>
          ...
          >
            <template v-slot:toolbar>
              <lay-button size="sm" type="primary" @click="displayFromLay('新增', iotEquipmentDto())">
...
<script setup>
  ...
  import FromLay from '@/views/baseInfo/iotEquipment/FormLay.vue';
  import SearchBox from '@/views/baseInfo/iotEquipment/SearchBox.vue';
  import { list, remove, removeByIdList } from '@/api/module/IotEquipmentApi.js';
  ...
  const columns = [
      ...
      {title: "设备编号", key: "iotCode", ellipsisTooltip: true, align: "center"},
      {title: "运输设备ID", key: "transportEquipmentId", ellipsisTooltip: true, align: "center"},
      {title: "设备名称", key: "iotName", ellipsisTooltip: true, align: "center"},
      {title: "设备key", key: "iotKey", ellipsisTooltip: true, align: "center"},
      {title: "设备状态", key: "iotState", ellipsisTooltip: true, align: "center"},
      {title: "备注", key: "iotRemark", ellipsisTooltip: true, align: "center"},

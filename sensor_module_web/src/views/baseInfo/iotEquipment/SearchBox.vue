      ...
      <lay-row>
        <lay-col :md="6">
          <lay-form-item label="编码：" label-width="50">
            <lay-input v-model="localModelDto.iotCode" style="width: 90%;"/>
          </lay-form-item>
        </lay-col>
        <lay-col :md="6">
          <lay-form-item label="运输设备ID：" label-width="50">
            <lay-input v-model="localModelDto.transportEquipmentId" style="width: 90%;"/>
          </lay-form-item>
        </lay-col>
        <lay-col :md="6">
          <lay-form-item label="设备名称：" label-width="50">
            <lay-input v-model="localModelDto.iotName" style="width: 90%;"/>
          </lay-form-item>
        </lay-col>
        <lay-col :md="6">
          <lay-form-item label="状态：" label-width="50">
            <lay-select placeholder="设备状态" v-model="localModelDto.iotState" style="width: 90%;">
        ...
        <lay-col :md="6">
          <lay-form-item label="备注：" label-width="50">
            <lay-input v-model="localModelDto.iotRemark" style="width: 90%;"/>
          </lay-form-item>
        </lay-col>
        <lay-col :md="6">
...
<script setup>
  ...
  let localModelDto = iotEquipmentDto();
  ...
  function toReset() {
    ...
    Object.assign(localModelDto, iotEquipmentDto());
    renewalModelDto();
  }

        ...
        <lay-card>
          ...
          >
            <template v-slot:toolbar>
              <lay-button size="sm" type="primary" @click="displayFromLay('新增', transportEquipmentDto())">
...
<script setup>
  ...
  const columns = [
      ...
      {title: "设备编码", key: "equipmentCode", ellipsisTooltip: true, align: "center"},
      {title: "设备名称", key: "equipmentName", ellipsisTooltip: true, align: "center"},
      {title: "设备类型", key: "equipmentType", ellipsisTooltip: true, align: "center"},
      {title: "设备型号", key: "equipmentModel", ellipsisTooltip: true, align: "center"},
      {title: "设备品牌", key: "equipmentBrand", ellipsisTooltip: true, align: "center"},
      {title: "设备状态", key: "equipmentState", ellipsisTooltip: true, align: "center"},
      {title: "设备备注", key: "equipmentRemark", ellipsisTooltip: true, align: "center"},

      ...
      <lay-row>
        ...
        <lay-col :md="6">
          <lay-form-item label="使用状态" label-width="50">
            <lay-select placeholder="请选择使用状态" v-model="localModelDto.turnoverBoxState" style="width: 90%;">
...
<script setup>
  ...
  let localModelDto = turnoverBoxDto();
  ...
  function toReset() {
    ...
    Object.assign(localModelDto, turnoverBoxDto());
    renewalModelDto();
  }

...
import china from '@/views/workspace/middleMonitor/moudel/china.json'
import minx from '@/views/workspace/middleMonitor/moudel/minx.js'
...
onMounted(() => {
  ...
  userDistributionOption && userDistributionDomChart.setOption(userDistributionOption)
  ...
  browserDistributionOption && browserDistributionDomChart.setOption(browserDistributionOption)

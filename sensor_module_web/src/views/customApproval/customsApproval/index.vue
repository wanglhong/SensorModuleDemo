          ...
          >
            <template v-slot:toolbar>
              <lay-button
                size="sm"
                type="primary"
                @click="displayFromLay('新增', customsAuditDto())"
              >
            ...
            <template v-slot:userOfSubmit="{ data }">
              {{ data.userOfSubmit?.userName }}
            </template>
            <template v-slot:userOfAudit="{ data }">
              {{ data.userOfAudit?.userName }}
            </template>
            ...
            <template v-slot:operator="{ data }">
              <lay-button size="xs" type="normal" @click="viewDoc(data)"
                >查看附件</lay-button
              >
              <lay-button
                size="xs"
...
import FromLay from '@/views/customApproval/customsApproval/FormLay.vue'
import SearchBox from '@/views/customApproval/customsApproval/SearchBox.vue'
import { list, remove, removeByIdList } from '@/api/module/customsApproval.js'
